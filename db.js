...
export const accounts = [
    ...
    {name : 'Neon', id: crypto.randomUUID() }
]
...
export const transactions = [
    ...
    { tags: ['teste', 'teste2', 'teste3', 'teste4'], type: 'Entry', bankAccount: 'Neon', creditCard: 'American Express', value: 350, user: 'Bernardo', costCenter: 'RH', id: crypto.randomUUID()},
    ...
    { tags: ['teste2', 'teste3'], type: 'Entry', bankAccount: 'Neon', creditCard: 'Mastercard', value: 120, user: 'Sulivan', costCenter: 'RH', id: crypto.randomUUID() },
    ...
    { tags: ['teste2', 'teste4', 'unica'], type: 'Out', bankAccount: 'Neon', creditCard: 'Elo', value: 3214, user: 'Sulivan', costCenter: 'P&D', id: crypto.randomUUID() },
]
